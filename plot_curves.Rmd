...
data[data$method == "Conditional (kernel)", "method"] <- "Conditional-CP"
data[data$method == "Marginal", "method"] <- "Unconditional"
...
data$method <- factor(data$method, levels = c("SC-CP (ours)", "Conditional-CP", "Unconditional"))
